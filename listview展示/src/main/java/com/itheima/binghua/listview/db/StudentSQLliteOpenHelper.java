package com.itheima.binghua.listview.db;
 ...
 */
public class StudentSQLliteOpenHelper extends SQLiteOpenHelper 
{
    private static final String TAG = "StudentSQLliteOpen";   
    public StudentSQLliteOpenHelper(Context context) 
    {
        //该构造方法自定义
        super(context, "firstSQLlite.db", null, 1);
    }
